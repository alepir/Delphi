...
implementation
    ...
    begin
      SaveChanges := True;
      code := MessageDlg('Dokument ' + filename + ' byl zmìnìn. chcete uložit zmìny?',mtInformation,mbYesnoCancel,0);
...
begin
  MessageDlg('Notepad vytvoøený v Delphi v rámcí studia Informaèních technologií Pavlem Šestákem',mtInformation,[mbOK],0);
end;
...
begin
  ...
  MessageDlg('Tento text má '+text+' znakù.',mtInformation,[mbOK],0);
end;
